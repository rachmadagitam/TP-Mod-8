...
$pla = new place();
$tempat = $pla->cariTempat($_POST['cari']);
$cr = $tempat->fetch(PDO::FETCH_OBJ);
echo '
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
							<a href="login.php"><i class="fa fa-sign-out fa-fw"></i> Log Out</a>
						</li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
									while($data = $tempat->fetch(PDO::FETCH_OBJ);){
                                        <tr>
											...
											<td><a class="btn btn-danger" href="lihatTempat.php?delete=$data->kode_tempat_wisata">Delete</a></td>
											<td><a class="btn btn-info" href="editPlace.php?kodeT=$data->kode_tempat_wisata">Edit</td>
                                        </tr>
									}
                                    </tbody>
                                </table>
